...
The gendered basis of the exemplary question has so much buried under it that we must suspect as subversive on Turing's part; subversive in being in plain side, but possibly illegible to his contemporary audience. Gender is a socially saturated category, mediated by language, and subject to stereotype, expectation, and misreading. In English particularly there is no stable linguistic essence to gender; in the context of the game, gender must be performed and inferred, misidentification is the only *likely* outcome. He has set up a domain where the interior truth of the participants is inaccessible, exterior singals are unreliable, and evaluation is social, and subject to chance.

The game is explicitly about playing a role, adopting a strategy, adapting to partial information, and exploiting the judge's biases and expectations. The game requires performance, misdirection is essential, and success isn't achieved through telling the truth but by manipulating an epistemic interface. The Imitation Game is therefore a sophisticated methodological quarantine; by focusing on interaction it keep metaphysics and interiority out of the discussion entirely. It seems that the game is less a test of intelligence than an argument that it's sufficient not to probe interiority and to focus on observable outcomes.

## Smuggling Intelligence

Turing was operating in an intellectual climate where internal states for methodologically inaccessible. The emerging dominant though of the time was centered on post-war cybernetics, behaviorism in psychology, and logical positivism's suspicion of metaphysics. Turing's personal and professional life positioned him simultaneously as an insider and an outsider. His work in cryptographer isolated him as a crucial insider in the top secret facility at Bletchley Park. His queerness had a similar aspect; homosexuality was criminal at the time mimicking his professional contradictions in his personal life.
